...
const USER_CONFIG = {
  ...
  // 使用微信测试号：公众号APP_ID
  APP_ID: 'wx29bdb0c66b4629d2',

  // 使用微信测试号：公众号APP_SECRET
  APP_SECRET: '33d85c1da738b10c77b815700a06c81b',
  ...
  USERS: [
    {
      ...
      useTemplateId: 'BKHibffHgXtxCeFbFopreltiJspLw7t29ZDwu0fK_Ws',
      // 新历生日, 仅用作获取星座运势, 格式必须为MM-DD
      horoscopeDate: '01-26',
      festivals: [
        // 注意：此条配置日期为阴历日期，因为`type`中 “生日” 之前有 * 符号
        {
          type: '*生日', name: '宝贝', year: '1998', date: '12-28',
        },
  ...
  CALLBACK_USERS: [
    {
      ...
      id: 'oyymf5ypZ4sclM0JZdXOt12SBY0Q',
    }
  ],
